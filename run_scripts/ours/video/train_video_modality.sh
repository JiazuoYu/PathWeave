...
train_yaml_path=/15324359926/Multimodal/hm_repo/03_adapter_in_adapter/depth2pc/lavis/projects/xinstruct_blip/train/vicuna7b/video_training_frozen_and_adapter_no_relu_neckDim8_all_layer.yaml
