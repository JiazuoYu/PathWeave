...
from lavis.datasets.builders.depth_qa_builder import DepthFusionInstructBuilder_In_Domain, DepthFusionInstructBuilder, DepthQAInstructBuilder
...
__all__ = [
    ...
    # Depth
    "DepthFusionInstructBuilder_In_Domain",
    "DepthFusionInstructBuilder", 
    "DepthQAInstructBuilder"
