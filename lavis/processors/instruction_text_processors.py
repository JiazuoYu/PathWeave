...
TEMPLATES = {"image":{}, "pc":{}, "audio":{}, "video":{}, "depth":{}}

TEMPLATES["depth"]["qa"] = [
"Given the depth, {}",
"Q: {} A:",
"Answer the following question based on the depth: {}",
"Question: {} Answer:",
"How would you answer {} after watching the depth?",
"What is the answer to the question {} after viewing the depth?",
"Answer the question based on the depth. Question: {} Answer: ",
"Instruction: Answer the following question by reference to the input depth. Question: {} Answer:",
"Given the depth, what is the answer to the question {}?",
"What's your response to the query {} after watching the depth?",
"Please provide an answer to {} after watching the depth",
"Respond to the query {} based on the depth",
"Based on the given depth, respond to {}",
"Question: {} What's your response after watching the depth?",
"Consider the following query: {}",
"Could you help answer the question {}?",
"Referencing the provided depth, can you answer the question {}?",
"With respect to the depth shown, please answer {}",
"What's your answer to {} in the context of the provided depth?",
"Question (refer to the depth for context): {} Answer:",
"In response to the question {}, what would your answer be after viewing the depth?"
]

TEMPLATES["depth"]["classification"] = [
"Identify the objects in this depth:",
"What objects can you spot in the clip?",
"Classify the objects in the depth:",
"Name the objects visible in the depth:",
"Identify and classify the objects in this depth:",
"What type of objects are in the depth?",
"Classify the main object in the clip:",
"Identify the primary object in this depth:",
"Name the main object visible in the clip:",
"What is the central object in the depth?",
"Can you classify the central object in this depth?",
"Determine the type of the main object in this depth:",
"What objects do you identify in the depth?",
"Please classify the objects in the depth:",
"Please identify the main object in the depth:",
"What kind of object is displayed in the depth?",
"What object is predominantly featured in the depth?",
"Classify the object that is the focus of this depth:",
"What is the main object in the depth?",
"Identify the primary object in the depth:"
]

TEMPLATES["depth"]["caption"] = [
